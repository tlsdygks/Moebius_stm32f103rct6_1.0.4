...
#define HIGH_SPEED		0x03			//GPIO速度选择
...
#define	INPUT			INPUT_PULLUP			//默认上拉输入
#define	OUTPUT			OUTPUT_PP				//推挽输出
...
void pinMode(unsigned char GPIOx, unsigned char Pin, unsigned char Mode);		//输入输出端口初始化
